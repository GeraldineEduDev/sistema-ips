...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href=" {{ asset('assets/images/logos/favicon.pn') }}" />
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('pacientes.index') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('muestras.index') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('facturas.index') }}" aria-expanded="false">
                <span>
